    ...
    if is_plot_phase
        % 绘制动态比相测向误差曲线
            plot(alpha_angle, meanErrorPhase, ...
                ...
                'Color', colors(var_index, :), ...
                'LineWidth', 1, ...
                'DisplayName', 'Dynamic Phase-comparing');
    end
    % SNR标注
    text(53, 1.4, '\downarrow-10dB');
    % 记录总平均误差
